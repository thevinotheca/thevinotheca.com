...
3. **Git.** The agent stages files and writes commits. The operator pushes. No branch is created or switched; all work is on `main`. A commit message states what changed in plain terms.
